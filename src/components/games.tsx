...
const Games: React.FC<LangProps> = memo(({ t, i18n, theme, setTheme }) => {
    ...
    return (
        <>
            ...
            <div className={`${tS.bgColor} w-full md:w-auto h-[auto] md:h-[37rem] pb-[2rem] md:pb-[10rem] flex flex-col flex-nowrap justify-evenly items-center transition-all duration-[250ms] ease-linear z-10`}>
