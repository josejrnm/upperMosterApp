...
const ChangeTheme: React.FC<ChangeThemeProps> = ({ setTheme, theme }) => {
    ...
    return (
        <>
            <div className={`flex flex-row w-[3.5rem] h-[2.2rem] shadow-[#004400] shadow-sm ${tS.bgColor} m-2 ${theme ? "pl-[0.1rem]" : "pl-[1.3rem]"} items-center rounded-full cursor-pointer transition-all duration-[250ms] ease-in`} onClick={toggleTheme}>
